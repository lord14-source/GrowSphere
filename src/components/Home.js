...
function Home() {
    return (
        <div className="main-layout">
            {/* Sidebar */}
            <div className="sidebar" style={{height:'100vh',marginTop:'5.6%',position:'fixed',width:'250px',overflowY:'auto',zIndex:'1'}}>
            ...
            {/* Main Content Area */}
            <div className="content" style={{marginLeft:'250px',overflowY:'auto',height:'100vh'}}>
                <Container>
